...
const About = () => {
  return (
    <div id="about" style={{paddingTop:"60px",backgroundColor:"#152242",height:"400px"}}>
    <Stack spacing="14" align="center">
    <Heading  className="heading">About Me</Heading>
     <Text fontSize={{base:"lg",md:"xl",lg:"xl"}} textAlign={{base:"center",md:"center",lg:"left"}} marginTop="200px" w="80%" m="auto" color={'gray.500'}>Passionate about coding and eager to work with smart people in a challenging environment. Having exceptional interpersonal skills as well as the ability to produce interactions that organizations and people really care about. 
